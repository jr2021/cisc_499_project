...
export class NotebookPanel extends DocumentWidget {
    ...
    _onSessionStatusChanged(sender, status) {
        ...
        if (status === 'autorestarting' && !this._autorestarting) {
            ...
            void showDialog({
                ...
                body: `The kernel for ${(_a = this.sessionContext.session) === null || _a === void 0 ? void 0 : _a.path} appears to have died. It will restart automatically.`,
    ...
    async _updateSpec(kernel) {
        ...
        this.model.metadata.set('kernelspec', {
            name: kernel.name,
            display_name: (_a = spec) === null || _a === void 0 ? void 0 : _a.display_name,
            language: (_b = spec) === null || _b === void 0 ? void 0 : _b.language
        });
    }
}
/**
