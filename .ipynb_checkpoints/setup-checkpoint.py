    ...
    app.layout = html.Div([dcc.Markdown('''##### Select a default configuration'''), 
                           dcc.Dropdown(id='pre_probs', 
                                        options=[{'label': 'Western Sahara TSP', 
                                                 ...
                                                 {'label': '10x10 Sudoku', 
                                                  'value': 'sudoku'}],
                                       placeholder='Problem Instances',style=
                                        {'width' : '55%'}),
                           ...
                           dcc.Markdown('''###### Objectives'''),
                           dbc.Row([
                           dbc.Col(children=(dcc.Dropdown(id='prob_type',
                           ...
                           dbc.Collapse(dbc.Card(dbc.CardBody('This is a required field')),
                               ...
                               dbc.Col(children=(dbc.Input(id='obj_1_name',
                               ...
                               dbc.Col(children=(dbc.Collapse(children=(dbc.Input(id='obj_2_name',
                           ...
                           dbc.Col(children=(dbc.Collapse(children=(dbc.Input(id='obj_3_name',
                           ...
                           dbc.Row([
                               dbc.Col(children=(dcc.Dropdown(id='enc_type',
                               ...
                               dbc.Collapse(dbc.Card(dbc.CardBody('This is a required field')),
                                           id='enc_type_error'))),
                               dbc.Col(children=(dbc.Input(id='gene_size',
                               ...
                               dbc.Collapse(dbc.Card(dbc.CardBody('Gene size must be non-negative')),
                                           id='gene_size_wrong'))),
                               dbc.Col(children=(dbc.Input(id='min_val',
                               ...
                               dbc.Collapse(dbc.Card(dbc.CardBody('This is a required field')),
                                           id='min_val_error'))),
                               dbc.Col(children=(dbc.Input(id='max_val',
